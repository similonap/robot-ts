...
import { RobotState, Position, SharedWorldState, RobotAppearance } from 'circuit-crawler';
import { RobotController } from 'circuit-crawler';
...
export const useRobots = () => {
    ...
    const initializeRobots = useCallback((initialConfigs: import('circuit-crawler').InitialRobotConfig[]) => {

...
import { MazeConfig, RobotState, RobotAppearance, Item } from "@/lib/types";
...
interface EngineConfig {
    ...
    externalWorld?: {
        actions: import('@/lib/types').SharedWorldState;
        reset: () => void;
    };
}
...
export class CircuitCrawlerEngine {
    ...
    public worldActions: import('@/lib/types').SharedWorldState;
